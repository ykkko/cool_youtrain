...
def Resnet34(pretrained, num_classes, in_planes):
    model = resnet34(pretrained=pretrained)
    model.fc = nn.Linear(in_planes, num_classes, bias=True)
    return model

def SENext50(pretrained, num_classes):
    model = se_resnext50(pretrained=pretrained)
    model.fc = nn.Linear(12288, num_classes, bias=True)
    return model

def Resnet18(pretrained, num_classes):
    model = resnet18(pretrained=pretrained)
    model.fc = nn.Linear(13824, num_classes, bias=True)
    return model
